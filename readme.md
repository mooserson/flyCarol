...
3. Download the latest JSON file; right click the `v0.x` and click *Save Link* ->: <a href="https://raw.githubusercontent.com/mooserson/flyCarol/master/current_version/v0.3user-js-css-v8-200917.json" download>v0.3</a>
